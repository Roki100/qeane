module.exports = {
  ...
  async execute(client, msg) {
    if (!msg.member.permissions.toArray().includes("ADMINImsg.str.ATOR")) return msg.reply(`${msg.author.tag}: ` + msg.str.lackOfPermissions);
    if (!msg.args.join(' ')) return msg.reply(`${msg.author.tag}: ` + msg.str.usage)
    if (msg.args[0] === "list") {
      let langstr = [];
    ...
    if (!language) return msg.reply(`${msg.author.tag}: ` + `${msg.str.invalidLanguage}\n${msg.str.usage}`)
